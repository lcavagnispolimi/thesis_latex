...
\end{figure}
%%TODO Cap3: sistemare referenziamento subfigures

I primi dispositivi programmabili, chiamati PLA (\textit{Programmable Logic Array}) si basavano su questa architettura, con una struttura a due livelli, AND e OR. Un esempio di PLA è mostrato in Figura \ref{plas}(a).
...
%%TODO Cap3: sistemare ref subfigure
\begin{figure}
\centering
\subfigure[Static Memory Cell]
{\includegraphics[scale=.3]{cap3/sma}}
\hspace{5mm}
\subfigure[Multiplexer con Static Memory Cell]
{\includegraphics[scale=.3]{cap3/smb}}
\hspace{5mm}
\subfigure[Static Memory Cell e Lookup Table]
{\includegraphics[scale=.3]{cap3/smc}}

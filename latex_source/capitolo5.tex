...
{\label{misfisso1b}\includegraphics[scale=.4]{cap5/misfisso1b}}
...
\begin{enumerate}
	...
	Le prime curve ricavate vengono presentate in Figura \ref{mulfact}. Si può notare che sia per il fronte di salita che per il fronte di discesa il minimo si trova nell'intorno di $0.2$. I valori esatti ricavati nella seconda iterazione sono $0.18$ per il fronte di discesa e $0.22$ per il fronte di salita.
		\begin{figure}[H]
			...
			{\label{}\includegraphics[scale=.5]{cap5/mulfactdiscesa}}
		\end{figure}
		\begin{figure}[H]
			\centering
			\subfigure[Semiperiodo di salita]
			{\label{}\includegraphics[scale=.5]{cap5/mulfactsalita}}
...
\begin{figure}[H]
	\centering
	\subfigure[Distribuzione dei valori misurati rispetto alla media]
	{\label{misfisso5b20}\includegraphics[scale=.35]{cap5/misfisso5b20}}
...
\begin{figure}[H]
	\centering
	\subfigure[Semiperiodo di discesa]
	{\label{}\includegraphics[scale=.5]{cap5/mulfactdiscesanew}}
\end{figure}
\begin{figure}[H]
	\centering
	\subfigure[Semiperiodo di salita]
	{\label{}\includegraphics[scale=.5]{cap5/mulfactsalitanew}}
...
\begin{figure}[H]
	\centering
	\subfigure[Semiperiodo di discesa]
	{\includegraphics[scale=.5]{cap5/primadopocompdiscnew}}
\end{figure}
\begin{figure}[H]
	\centering
	\subfigure[Semiperiodo di salita]
	{\includegraphics[scale=.5]{cap5/primadopocompsalnew}}

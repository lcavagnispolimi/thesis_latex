...
%% TODO Cap4 Commentare pseudocodice FFT
\begin{algorithm}
...
\begin{figure}  
  \begin{center}
    \includegraphics[scale=0.4]{cap4/prodcons}
...
\begin{figure}  
  \begin{center}
    ...
    \caption{Confronto dello spazio occupato da un sommatore su FPGA con Fixed Point o Floating Point}
    \label{fxpvsfloat}
  \end{center}
\end{figure}
...
\begin{figure}  
  \begin{center}
    \includegraphics[scale=0.5]{cap4/dmafunz}

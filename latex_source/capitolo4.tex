...
\begin{figure}[H] 
  \begin{center}
    \includegraphics[scale=0.7]{cap4/nodocoll}
...
{\label{timedloop}\includegraphics[scale=0.6]{cap4/timed}}
\hspace{5mm}
...
\begin{figure}[H]  
  \begin{center}
    \includegraphics[scale=0.7]{cap4/spectleak}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[scale=0.5]{cap4/hann}
...
\begin{figure}[H] 
  \begin{center}
    \includegraphics[scale=0.5]{cap4/smoothwins}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=0.6]{cap4/codicefpga}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[scale=0.8]{cap4/pipelinevi}
...
\begin{figure}[H]  
  \begin{center}
    \includegraphics[scale=0.4]{cap4/fftloop}
...
\begin{figure}[H]  
  \begin{center}
    \includegraphics[scale=0.35]{cap4/configfft}
...
\begin{figure}[H]  
	\begin{center}
	  %% TODO Sgranata da migliorare (mettere 12 bit signed)
		\includegraphics[scale=0.7]{cap4/configfxp}
